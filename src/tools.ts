...
const itemPayloadFields = {
  ...
  purchaseTime: z.string().min(1).optional().describe("Homebox UI: Purchase date / Data zakupu. Sent to Homebox as purchaseDate (v0.26 expects purchaseDate, not purchaseTime). Format YYYY-MM-DD or ISO 8601."),
  purchaseDate: z.string().min(1).optional().describe("Direct Homebox purchase date. Prefer purchaseTime which is translated to purchaseDate automatically."),
